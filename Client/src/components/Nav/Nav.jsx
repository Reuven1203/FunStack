                     ...
                     {Links.map((link, index) => {
                            return (
                                <Link key={index} className="w-full">
                                    <Paper sx={{backgroundColor:`${link.color}`,fontSize:45, width:'100%', display:'flex',alignItems:'center', justifyContent:"center", height:120}}>
                                        <span className="text-6xl">{link.icon}{link.secondIcon}</span><span className="text-black"> {link.name}</span>
                                    </Paper>
                                </Link>
                            )
                     })}
