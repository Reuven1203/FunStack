    ...
    return (
        <div className="w-full h-full flex justify-center mt-7">
                ...
                <div className="flex space-x-5 mt-[5rem]">
                    {shapes.map((shape, index) => {
                            return (
                                <Button
                                    key={index}
                                    style={{backgroundColor: shape.color, color: 'white', width: '200px', height: '200px', fontSize: '25px'}}
                                    onClick={() => {
            ...
            {done && <div className="flex-col justify-center align-center items-center">
                <h1 className="text-center">You got {score} out of {shapes.length} correct!</h1>
            </div>
            }
