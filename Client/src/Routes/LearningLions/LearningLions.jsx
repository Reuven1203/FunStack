...
const activities = [
    ...
    },
    {
        ...
        link:'animals',
        color: 'yellow',
        img:'https://cdn5.vectorstock.com/i/1000x1000/58/19/funny-animal-cartoon-with-blank-sign-vector-1075819.jpg'
    }];
const LearningLions = () => {
    return (
                ...
                {activities.map((activity) => {
                    return (
                        <Link to={activity.link}>
                            <Card sx={{border:'4px solid',height:350, width:300, padding:3, display:"flex-col", justifyContent:'center', alignItems:'center', borderRadius:10,borderColor:`${activity.color}`}}>
